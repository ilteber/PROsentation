...
import prosentation.example.com.prosentation.Activities.UserProfileActivity;
...
//import prosentation.example.com.prosentation.FormatRelated.IAxisValueFormatter;
...
public class TabOverall extends Fragment implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        view = inflater.inflate(R.layout.fragment_userprofile_overalltab,container, false);
    ...
    private LineData generateDataLine(int cnt) {
        ...
        // XAxis x = progChart.getXAxis();
        //x.setValueFormatter(new AxisV);
        return cd;
    }
    ...
    public LineData setTotalResults(){
        ...
        for(int i = 0; i < 5; i++){
            ...
            //e1.add(new Entry(i, (int) presentation.getOverall()));
        ...
        for(int i = 0; i < presentations.size(); i++){
            entries1.add(new Entry(i, presentations.get(i).getOverall()));
        }
