...
public class TabGaze extends Fragment implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        view = inflater.inflate(R.layout.fragment_userprofile_gazetab,container, false);
        ...
        try {
            new TabGaze.MyPresentationsGetterBackground(presentations).execute().get();
    ...
    public LineData setTotalResults(){
        ...
        for(int i = 0; i < 5; i++){
            ...
            //e1.add(new Entry(i, (int) presentation.getGaze()));
        ...
        for(int i = 0; i < presentations.size(); i++){
            entries1.add(new Entry(i, presentations.get(i).getGaze()));
        }
